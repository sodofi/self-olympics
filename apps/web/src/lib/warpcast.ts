...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "which country will have the most humans", // 30 characters, no emojis or special characters, short description under app name
      description: "which country will have the most humans", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      ...
      ogDescription: "which country will have the most humans", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
